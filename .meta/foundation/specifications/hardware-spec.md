...
- **SSH Key:** `ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOwaC2BnZ21UfO9H5lHPQFjhNqPCu5FmL4L80QakZZ2O crtr@cooperator.local`
...
- **SSH Key:** `ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBdRuZENu/FtdtfC1F39m1udQs8RemLJHKFgUmqx7EnB prtr@projector`
...
- **SSH Key:** `ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIH5ihRxiCgoEZ+YF20D62nufnli7hUPnUVIcFIK4XgKE drtr@director`
...
- **SSH Key:** `ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIF8KDRHLnB9V9CFiG8AbnrKbUIPmZzrsw0MULPVr6RQG trtr@terminator`
...
```bash
# SSH config hosts predefined patterns
ssh crtr
ssh prtr
ssh drtr
ssh trtr
